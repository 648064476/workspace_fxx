package com.fxx.arithmetic.badword;
...
public class BadWordUtil2 {
    public static String filePath = "/Users/gantingting/work_space/project/myproject/github_fxx/workspace_fxx/springboot_test/src/main/resources/keywords";
    public static Set<String> words;
    public static Map<String, Map> wordMap;
    ...
    public static void main (String[] args) {
        ...
        Map<String, Map> wordMap = BadWordUtil2.wordMap;
        ...
        System.out.println(replaceBadWord(string, 1,"*"));
    }
}
